    ...
    public partial class Form1 : Form
    {
        ...
        private void WriteStrengthCsv()
        {
            ...
            if (!File.Exists("GameData.csv"))
            {
                ...
                {
                    sw.WriteLine("No.,Type,Time,PlayTime,AlarmName,Status,quantity_money,quantity_item");
                    sw.WriteLine($"{orderNum},{"Strength"},{DateTime.Now},{String.Format("{0:00}:{1:00}:{2:00}", ts.Hours, ts.Minutes, ts.Seconds)},{alarmName[characterLevel]},{result},{gameMoney},{gameItem}");
        ...
        private void WriteItemStrengthCsv()
        {
            ...
            if (!File.Exists("GameData.csv"))
            {
                ...
                {
                    sw.WriteLine("No.,Type,Time,PlayTime,AlarmName,Status,quantity_money,quantity_item");
                    sw.WriteLine($"{orderNum},{"ItemStrength"},{DateTime.Now},{String.Format("{0:00}:{1:00}:{2:00}", ts.Hours, ts.Minutes, ts.Seconds)},{alarmName[characterLevel]},{result},{gameMoney},{gameItem}");
                }
            }
            else
            {
        ...
        private void WriteSaleCsv()
        {
            ...
            if (!File.Exists("GameData.csv"))
            {
                ...
                {
                    sw.WriteLine("No.,Type,Time,PlayTime,AlarmName,Status,quantity_money,quantity_item");
                    sw.WriteLine($"{orderNum},{"Sale"},{DateTime.Now},{String.Format("{0:00}:{1:00}:{2:00}", ts.Hours, ts.Minutes, ts.Seconds)},{alarmName[characterLevel]}, {"blank"}, {gameMoney}, {gameItem}");
                }
            }
            else
            {
